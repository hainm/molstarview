...
# -*- coding: utf-8 -*-
#
# molstarview documentation build configuration file
#
...
_version_py = os.path.join(repo, 'molstarview', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'molstarviewdoc'
...
latex_documents = [
    (master_doc, 'molstarview.tex', 'molstarview Documentation',
     'Hai Nguyen', 'manual'),
]
